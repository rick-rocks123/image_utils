...
parser = argparse.ArgumentParser(
    ...
    epilog=r"Example: python main.py C:\Users\liebe\OneDrive\Pictures\wedding yonatan\A sneak peek of Julia & Yonatan_s Wedding\adira.jpg 90 b.jpg or you can use flags or even mix do -h to see them",
    prog="rotate_image"
)
